# Franka Research 3 (FR3) Description

## Overview

This package contains a simplified robot description of the [Franka Research 3 (FR3)](https://franka.de/products) developed by [Franka Robotics](https://franka.de). It is derived from [the franka_description package](https://github.com/frankarobotics/franka_description).
...
The original Franka Research 3 (FR3) assets are provided by Franka Robotics under the [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0). The derived assets in this directory are distributed under the same [Apache-2.0](./LICENSE).
